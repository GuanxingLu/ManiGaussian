...
from agents.gnfactor_bc.perceiver_lang_io import PerceiverVoxelLangEncoder
from agents.gnfactor_bc.qattention_gnfactor_bc_agent import QAttentionPerActBCAgent
from agents.gnfactor_bc.qattention_stack_agent import QAttentionStackAgent
...
def _add_keypoints_to_replay(
    ...
    for k, keypoint in enumerate(episode_keypoints):
        ...
        # sentence_emb, token_embs = language_model.encode_text_with_embeddings(token_tensor)
...
def fill_multi_task_replay(cfg: DictConfig,
    ...
    language_model = create_language_model(name=cfg.method.language_model)
