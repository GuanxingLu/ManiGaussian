...
flags.DEFINE_string('setting', 'FS10_V1', 'the few shot and multi task setting in RLBench')
...
def main(argv):
    ...
    task_setting = eval(FLAGS.setting)
    cprint('Task setting: %s' % FLAGS.setting, 'green')
    tasks = task_setting['train']
    cprint(tasks, 'green')
